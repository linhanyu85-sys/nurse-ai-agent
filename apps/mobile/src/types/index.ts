...
export type DraftEditableBlock = {
  key: string;
  label: string;
  section: string;
  value: string;
...
export type DocumentStructuredFields = {
  ...
  render_mode?: string;
  standardized_format?: boolean;
  editable?: boolean;
  editable_blocks?: DraftEditableBlock[];
  sections?: DraftSectionMeta[];
  missing_fields?: Array<{ key: string; label: string; section: string }>;
  field_summary?: { total?: number; filled?: number; missing?: number };
  manual_review_required?: boolean;
  draft_outline?: string[];
  standard_form?: StandardFormMeta;
...
export type DocumentDraft = {
  ...
  draft_text: string;
  status: string;
  structured_fields?: DocumentStructuredFields;
  source_type?: string;
...
export type StandardFormBundle = {
  document_type: string;
  form_id: string;
  name: string;
  standard_family?: string;
...
export type ResolvedScopePatient = {
  patient_id?: string;
  patient_name?: string;
  bed_no?: string;
  diagnoses: string[];
  risk_tags: string[];
  pending_tasks: string[];
  requested_bed_no?: string;
  resolved_bed_no?: string;
  bed_no_corrected: boolean;
  correction_note?: string;
};

export type PatientScopePreview = {
  question: string;
  department_id?: string;
  ward_scope: boolean;
  global_scope: boolean;
  extracted_beds: string[];
  unresolved_beds: string[];
  matched_patients: ResolvedScopePatient[];
};
